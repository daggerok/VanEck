...
const COLUMN_TOOLTIPS: Record<string, string> = {
  ...
  'TR 5Y': 'TR 5Y (5-Year Total Return) — cumulative return over 5 years, from VanEck\'s official Average Annual Total Returns table (NAV basis). "—" for a fund younger than 5 years.',
  'TR 10Y': 'TR 10Y (10-Year Total Return) — cumulative return over 10 years, from VanEck\'s official Average Annual Total Returns table (NAV basis). "—" for a fund younger than 10 years.',
  'CAGR 3Y': 'CAGR 3Y (3-Year Compound Annual Growth Rate) — from VanEck\'s official Average Annual Total Returns table (NAV basis). "—" for a fund younger than 3 years.',
  'CAGR 5Y': 'CAGR 5Y (5-Year Compound Annual Growth Rate) — from VanEck\'s official Average Annual Total Returns table (NAV basis). "—" for a fund younger than 5 years.',
  'CAGR 10Y': 'CAGR 10Y (10-Year Compound Annual Growth Rate) — from VanEck\'s official Average Annual Total Returns table (NAV basis). "—" for a fund younger than 10 years.',
  YTD: 'Year-to-date return published in the VanEck fund page header.',
  '1Y': '1-year total return, from VanEck\'s official Average Annual Total Returns table (NAV basis).',
  '3Y': '3-year average annual total return (CAGR), from VanEck\'s official Average Annual Total Returns table (NAV basis). "—" for a fund younger than 3 years.',
  '5Y': '5-year average annual total return (CAGR), from VanEck\'s official Average Annual Total Returns table (NAV basis). "—" for a fund younger than 5 years.',
  '10Y': '10-year average annual total return (CAGR), from VanEck\'s official Average Annual Total Returns table (NAV basis). "—" for a fund younger than 10 years.',
  'SI Ann.': 'Since-inception annualized total return, from VanEck\'s official Average Annual Total Returns table (NAV basis).',
...
function renderSubtitle(text?: string): void {
  ...
  const countsText = state.counts
    ...
    : '';
  const base = text ? String(text) : 'Search VanEck ETFs, select ETFs via the “Use” checkbox, then use the Watchlist tab.';
